# BypassYTembed
A clone of [brownsugar's codepen](https://codepen.io/brownsugar/pen/oNPzxKo) in case it goes down for some reason
...
In the case of this repo, use https://awelson.github.io/BypassYTembed/BypassYT?v=XXX for the source in the iframe embed instead 
